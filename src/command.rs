...
pub struct SourceList {
    ...
    /// Chinese color names from the UW Interactive Data Lab's Many Languages Many Colors project
    #[arg(long, visible_alias = "mlmc-zh")]
    pub mlmc_chinese: bool,
    /// Dutch color names from the UW Interactive Data Lab's Many Languages Many Colors project
    #[arg(long, visible_alias = "mlmc-nl")]
    pub mlmc_dutch: bool,
    /// English color names from the UW Interactive Data Lab's Many Languages Many Colors project
    #[arg(long, visible_alias = "mlmc-en")]
    pub mlmc_english: bool,
    /// Finnish color names from the UW Interactive Data Lab's Many Languages Many Colors project
    #[arg(long, visible_alias = "mlmc-fi")]
    pub mlmc_finnish: bool,
    /// French color names from the UW Interactive Data Lab's Many Languages Many Colors project
    #[arg(long, visible_alias = "mlmc-fr")]
    pub mlmc_french: bool,
    /// German color names from the UW Interactive Data Lab's Many Languages Many Colors project
    #[arg(long, visible_alias = "mlmc-de")]
    pub mlmc_german: bool,
    /// Korean color names from the UW Interactive Data Lab's Many Languages Many Colors project
    #[arg(long, visible_alias = "mlmc-ko")]
    pub mlmc_korean: bool,
    /// Persian color names from the UW Interactive Data Lab's Many Languages Many Colors project
    #[arg(long, visible_alias = "mlmc-fa")]
    pub mlmc_persian: bool,
    /// Polish color names from the UW Interactive Data Lab's Many Languages Many Colors project
    #[arg(long, visible_alias = "mlmc-pl")]
    pub mlmc_polish: bool,
    /// Portuguese color names from the UW Interactive Data Lab's Many Languages Many Colors project
    #[arg(long, visible_alias = "mlmc-pt")]
    pub mlmc_portuguese: bool,
    /// Romanian color names from the UW Interactive Data Lab's Many Languages Many Colors project
    #[arg(long, visible_alias = "mlmc-ro")]
    pub mlmc_romanian: bool,
    /// Russian color names from the UW Interactive Data Lab's Many Languages Many Colors project
    #[arg(long, visible_alias = "mlmc-ru")]
    pub mlmc_russian: bool,
    /// Spanish color names from the UW Interactive Data Lab's Many Languages Many Colors project
    #[arg(long, visible_alias = "mlmc-es")]
    pub mlmc_spanish: bool,
    /// Swedish color names from the UW Interactive Data Lab's Many Languages Many Colors project
    ...
    #[arg(long)]
    pub nbs_iscc: bool,
    /// NTC.js color matching library names, released in 2007
    #[arg(long)]
    pub ntc: bool,
    ...
    #[arg(long)]
    pub ral: bool,
    /// Color Nomenclature by Robert Ridgway, published in 1912
    #[arg(long)]
    pub ridgway: bool,
    ...
    #[arg(long)]
    pub thesaurus: bool,
    /// All colors from the book Werner's Nomenclature of Colours, collected in the late 18th century
    #[arg(long)]
    pub werner: bool,
    /// Color names used in legacy Microsoft Windows systems
    #[arg(long)]
    pub windows: bool,
    /// A list of color names from Wikipedia (The default option when no source list is given)
    #[arg(long)]
    pub wikipedia: bool,
    /// The 954 most common RGB monitor colors, as defined by participants in the XKCD color name survey
    #[arg(long)]
    pub xkcd: bool,
